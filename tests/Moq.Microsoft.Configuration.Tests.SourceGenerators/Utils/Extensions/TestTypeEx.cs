		...
		public static TypeDetails[] CreateDetails(this Array @this)
		{
			...
			for (var i = 0; i < @this.Length; i++)
			{
				...
				array[i] = val switch
				{
					...
					TestType.IntEnumNullable => new TypeDetails(val, "IntEnum", true) { ValueTexts = IntEnumValueTexts, ParseMethodConverter = EnumParseMethodConverter },
					...
					TestType.UintEnumNullable => new TypeDetails(val, "UintEnum", true) { ValueTexts = UintEnumValueTexts, ParseMethodConverter = EnumParseMethodConverter },
					...
					TestType.ByteEnumNullable => new TypeDetails(val, "ByteEnum", true) { ValueTexts = ByteEnumValueTexts, ParseMethodConverter = EnumParseMethodConverter },
					...
					TestType.SbyteEnumNullable => new TypeDetails(val, "SbyteEnum", true) { ValueTexts = SbyteEnumValueTexts, ParseMethodConverter = EnumParseMethodConverter },
					...
					TestType.ShortEnumNullable => new TypeDetails(val, "ShortEnum", true) { ValueTexts = ShortEnumValueTexts, ParseMethodConverter = EnumParseMethodConverter },
					...
					TestType.UshortEnumNullable => new TypeDetails(val, "UshortEnum", true) { ValueTexts = UshortEnumValueTexts, ParseMethodConverter = EnumParseMethodConverter },
					...
					TestType.LongEnumNullable => new TypeDetails(val, "LongEnum", true) { ValueTexts = LongEnumValueTexts, ParseMethodConverter = EnumParseMethodConverter },
					...
					TestType.UlongEnumNullable => new TypeDetails(val, "UlongEnum", true) { ValueTexts = UlongEnumValueTexts, ParseMethodConverter = EnumParseMethodConverter },
